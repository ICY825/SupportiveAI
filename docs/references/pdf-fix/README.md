...
| --- | --- | --- |
| `zone-16-bds-smart-city` | 14 đỉnh, 522,4 m², 143 chỗ, x 121–642 | Hình lược, luồn theo các dãy bàn ở cánh A. **Dữ liệu không mâu thuẫn**: không chỗ ngồi nào nằm trong hai khu vực cùng lúc, VINFAST-KDO2O (y 211–364) nằm ngay trên BĐS (từ y 366) chứ không bị bao. Vấn đề — nếu có — là chuyện nghiệp vụ: phòng ban này có thật sự ngồi ở đó không. Cần người xác nhận, không suy ra được từ bản vẽ. |
